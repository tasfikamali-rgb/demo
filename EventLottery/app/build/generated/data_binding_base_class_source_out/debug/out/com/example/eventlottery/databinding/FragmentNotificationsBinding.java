...
public final class FragmentNotificationsBinding implements ViewBinding {
  ...
  private FragmentNotificationsBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout llEmpty, @NonNull ProgressBar progress,
      @NonNull RecyclerView rvNotifications, @NonNull TextView tvMarkRead) {
    this.rootView = rootView;
    this.llEmpty = llEmpty;
    this.progress = progress;
    this.rvNotifications = rvNotifications;
    this.tvMarkRead = tvMarkRead;
  }
  ...
  public static FragmentNotificationsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_mark_read;
      TextView tvMarkRead = ViewBindings.findChildViewById(rootView, id);
      if (tvMarkRead == null) {
        break missingId;
      }

      return new FragmentNotificationsBinding((LinearLayout) rootView, llEmpty, progress,
          rvNotifications, tvMarkRead);
    }
